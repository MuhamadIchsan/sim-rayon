        ...
        <div class="card">
            ...
            <div class="card-body">                
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" class="form-control @error('') is-invalid @enderror" value="" name="" placeholder="Nama">
                        @error('')
                        <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="email" class="form-control @error('') is-invalid @enderror" value="" name="" placeholder="E-mail">
                        @error('')
                        <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="password" class="form-control @error('') is-invalid @enderror" value="" name="" placeholder="Password">
                        @error('')
                        <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
