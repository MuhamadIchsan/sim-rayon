        ...
        <div class="card">
            ...
            <div class="card-body">                
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="date" class="form-control @error('') is-invalid @enderror" name="" placeholder="NIS Siswa">
                        @error('')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        <input type="time" class="form-control @error('') is-invalid @enderror" name="" placeholder="Nama Siswa">
                        @error('')
                        <small class="text-danger">{{$message}}</small>
                        @enderror
                    </div>
